...
public class SeedAllData(IServiceProvider serviceProvider)
{
    ...
    private static readonly List<string>? EmployeeIdList = [];
    private static readonly List<string>? CompanyIdList = [];
    private static readonly List<string>? CompanyRepIdList = [];
    private static readonly List<Customer> CompanyRepList = [];
    private static readonly List<string>? CustomerIdList = [];
    private static readonly List<string>? GuestIdList = [];
    private static readonly List<string>? ProductIdList = [];
    private static readonly List<Product>? ProductList = [];
    private static readonly List<string>? TagIdList = [];

    public async Task SeedEmployeeAsync()
    {
        List<Address> employeeAddressList = [];
    ...
    {
        const string uniqueEmail = "test@test.com";
    ...
    {
        List<Tag> tags = [];
        Dictionary<string, List<(string Category, List<string> SubCategories)>> categoriesByOccasion = new()
        {
            ["Begravelse"] =
            [
        ...
        {
            foreach (var (Category, SubCategories) in occasion.Value)
            {
    ...
    public async Task SeedProductsAsync()
    {
        ...
        {
            new() { ProductId = ProductIdList[0], TagId = TagIdList[0] },
            new() { ProductId = ProductIdList[0], TagId = TagIdList[165] },
            new() { ProductId = ProductIdList[0], TagId = TagIdList[166] },
            new() { ProductId = ProductIdList[1], TagId = TagIdList[4] },
            new() { ProductId = ProductIdList[1], TagId = TagIdList[7] },
            new() { ProductId = ProductIdList[2], TagId = TagIdList[15] },
            new() { ProductId = ProductIdList[3], TagId = TagIdList[102] },
            new() { ProductId = ProductIdList[3], TagId = TagIdList[163] },
            new() { ProductId = ProductIdList[4], TagId = TagIdList[124] },
            new() { ProductId = ProductIdList[4], TagId = TagIdList[128] },
            new() { ProductId = ProductIdList[4], TagId = TagIdList[169] },
            new() { ProductId = ProductIdList[5], TagId = TagIdList[63] },
            new() { ProductId = ProductIdList[6], TagId = TagIdList[66] },
            new() { ProductId = ProductIdList[7], TagId = TagIdList[114] },
            new() { ProductId = ProductIdList[8], TagId = TagIdList[55] },
            new() { ProductId = ProductIdList[9], TagId = TagIdList[158] },
            new() { ProductId = ProductIdList[10], TagId = TagIdList[161] },
            new() { ProductId = ProductIdList[11], TagId = TagIdList[155] },
            new() { ProductId = ProductIdList[12], TagId = TagIdList[36] },
            new() { ProductId = ProductIdList[13], TagId = TagIdList[75] },
            new() { ProductId = ProductIdList[13], TagId = TagIdList[77] },
            new() { ProductId = ProductIdList[14], TagId = TagIdList[126] }
        };
    ...
    {
        List<Order> orders = [];
        List<SpecialOrderInstruction> soiList = [];
    ...
    {
        List<BasketActivity> basketActivities = [];
